...
/**
 * @title ZapLockerLPThruster
 * @dev This contract allows users to perform a Zap operation by swapping ETH for
 * Zero tokens, adding liquidity to Nile LP, and locking LP tokens.
 */
contract ZapLockerLPThruster {
    address public odos;
        ...
        payable
    {
        ...
        if (!success) revert ThrusterSwapFailed();
